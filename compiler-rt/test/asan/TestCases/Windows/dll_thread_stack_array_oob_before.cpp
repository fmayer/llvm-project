...
// CHECK-NEXT:  thread_proc{{.*}}dll_thread_stack_array_oob_before.cpp:[[@LINE-3]]
//
// CHECK: Address [[ADDR]] is located in stack of thread T1 at offset [[OFFSET:.*]] in frame
// CHECK-NEXT:  thread_proc{{.*}}dll_thread_stack_array_oob_before.cpp
//
...
// CHECK:         test_function{{.*}}dll_thread_stack_array_oob_before.cpp:[[@LINE-2]]
